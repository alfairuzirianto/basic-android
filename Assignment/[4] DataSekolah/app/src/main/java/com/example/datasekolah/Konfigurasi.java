...
public class Konfigurasi {
    ...
    public static final String URL_SISWA_TAMBAH =
            "http://192.168.1.3/datasekolah2/siswa/siswa_tambah.php";  // URL untuk tambah siswa

    public static final String URL_SISWA_TAMPIL =
            "http://192.168.1.3/datasekolah2/siswa/siswa_tampil.php";  // URL untuk menampilkan data siswa

    public static final String URL_SISWA_TAMPIL_DETAIL =
            "http://192.168.1.3/datasekolah2/siswa/siswa_tampil_detail.php?idsiswa=";  // URL untuk menampilkan detail siswa

    public static final String URL_SISWA_EDIT =
            "http://192.168.1.3/datasekolah2/siswa/siswa_edit.php";  // URL untuk mengedit data siswa

    public static final String URL_SISWA_HAPUS =
            "http://192.168.1.3/datasekolah2/siswa/siswa_hapus.php?idsiswa=";  // URL untuk menghapus siswa berdasarkan ID
